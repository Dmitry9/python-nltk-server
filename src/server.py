...
def transcript():
    ...
    transcript = YouTubeTranscriptApi.get_transcript(videoid, proxies={"http": "http://brd-customer-hl_9f5a0152-zone-data_center:i23vcr837xxg@brd.superproxy.io:22225"})
